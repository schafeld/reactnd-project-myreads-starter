// This is mocked static content, 
// to be removed when using backend service for books data

import React, { Component } from 'react'

export default class ContentMock extends Component {
  render () {
    return (
        ...
        <div className="list-books">
            ...
            <div className="open-search">
                <a href="./search" title="back to search page">Add a book</a>
            </div>

            <div className="author copyleft">
                Made by <a href="/author">Olli</a>
            </div>
        </div>
